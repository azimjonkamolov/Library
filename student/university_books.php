                        ...
                        <div class="title_right">
                            <div class="col-md-5 col-sm-5 col-xs-12 form-group pull-right top_search">
                                <div class="input-group">
                                    ...
                                    <button class="btn btn-default" type="button"><input type="submit" name="submit" value="Go" style="border: none; decoration: none; background-color: transparent; margin: 0; padding: 0;"></button>
                                    </span>
                                </div>
                            </div>
                        </div>
